      ...
      for (i <- 0 until 1000) {
        ...
        for (i <- 0 until n) {
          ...
          dut.io
            ...
            .a
            .poke(
              Random.between(0, Math.pow(2, dut.io.in(i).bits.a.getWidth)).toInt
            )
          dut.io
            .in(i)
            .bits
            .b
            .poke(
              Random.between(0, Math.pow(2, dut.io.in(i).bits.b.getWidth)).toInt
            )
          dut.io
            .in(i)
            .bits
            .c
            .poke(
              Random.between(0, Math.pow(2, dut.io.in(i).bits.c.getWidth)).toInt
            )
        }
