...
import coralnpu.{FRegfileRead, FRegfileWrite, Parameters, RegfileReadDataIO, RegfileWriteDataIO}
...
object FloatInstruction {
  def decode(inst: UInt, addr: UInt): Valid[FloatInstruction] = {
    ...
    val uses_rs3  = opcode.bits.isOneOf(
      FloatOpcode.MADD,
      FloatOpcode.MSUB,
      FloatOpcode.NMADD,
      FloatOpcode.NMSUB
    ...
    val float_rs1 = !opcode.bits.isOneOf(
      FloatOpcode.STOREFP,
      FloatOpcode.LOADFP
    ) && !scalar_rs1
