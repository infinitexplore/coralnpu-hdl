...
object Secded {
  ...
  /**
   *  Calculates a 39-bit word (32-bit data, 7-bit ECC) using the same logic as
   *  OpenTitan's `prim_secded_inv_39_32_enc`.
   */
  ...
  /**
   *  Calculates a 64-bit word (57-bit data, 7-bit ECC) using the same logic as
   *  OpenTitan's `prim_secded_inv_64_57_enc`.
   */
