...
object EmitSlice extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), false, false, false),
    args
  )
}
...
object EmitSlice_1 extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), false, false, true),
    args
  )
}
...
object EmitSlice_2 extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), false, true, false),
    args
  )
}
...
object EmitSlice_3 extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), false, true, true),
    args
  )
}
...
object EmitSlice_4 extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), true, false, false),
    args
  )
}
...
object EmitSlice_5 extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), true, false, true),
    args
  )
}
...
object EmitSlice_6 extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), true, true, false),
    args
  )
}
...
object EmitSlice_7 extends App {
  ChiselStage.emitSystemVerilogFile(
    new Slice(UInt(32.W), true, true, true),
    args
  )
}
