...
object Fma {
  ...
  def FmaStage2(state1: FmaState1): FmaState2 = {
    ...
    val c_significand  =
      Mux(state1.sub, -(state1.c_significand.zext), state1.c_significand.zext)
  ...
  def FmaStage3(state: FmaState2): Fp32 = {
    ...
    val reduced_significand = shifted_significand(
      shifted_significand.getWidth - 1,
